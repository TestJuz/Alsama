...
export const limitedPromotions = [
  {
    ...
    copy: {
      en: {
        ...
        eligibilityNote: "Published promotional rates are exclusively for Costa Rican nationals. If you are not a Costa Rican national, ask us for the available promotional price.",
      ...
      es: {
        ...
        eligibilityNote: "Las tarifas promocionales publicadas son exclusivamente para nacionales costarricenses. Si no eres nacional, consulta con nosotros el precio promocional disponible.",
      ...
      fr: {
        ...
        eligibilityNote: "Les tarifs promotionnels affiches sont exclusivement reserves aux ressortissants costariciens. Si vous n\'etes pas ressortissant costaricien, demandez-nous le tarif promotionnel disponible.",
